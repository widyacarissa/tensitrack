        ...
        <div class="section-body">
            ...
            <div class="card shadow-sm">
                <div class="card-body p-4">
                    <form action="{{ route('admin.rule.update', $tingkatRisiko->id) }}" method="post">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group">
                            <label class="form-label font-weight-bold" style="color: #001B48; font-size: 16px;">Faktor Risiko</label>
                            <p class="text-muted small mb-3">
                                Klik kotak faktor risiko untuk mengubah pilihan. Faktor risiko yang dipilih ditandai dengan warna <b style="color: #001B48">Biru Gelap</b>.
                            </p>
                            ...
                            <div class="faktor-risiko-container" id="faktorRisikoContainer">
                                @foreach ($faktorRisiko as $fr)
                                    @php
                                        $isChecked = in_array($fr->id, $selectedFaktorRisiko);
                                    @endphp

                                    <label class="faktor-risiko-card {{ $isChecked ? 'active' : '' }}" id="card_{{ $fr->id }}">
                                        <input type="checkbox" 
