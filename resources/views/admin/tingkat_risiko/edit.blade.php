...
@section('content')
    <section class="section">
        <div class="section-header">
            <h1>Halaman Edit Tingkat Risiko Kode {{ $tingkatRisiko->kode }}</h1>
        </div>
                ...
                <div class="card-body p-4">
                    <form action="{{ route('admin.tingkat-risiko.update', ['id' => $tingkatRisiko->id]) }}" method="post">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <input type="text" class="form-control" value="{{ $tingkatRisiko->kode }}" readonly>
                        </div>
                        <div class="form-group mb-4">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <textarea required class="form-control @error('keterangan') is-invalid @enderror" name="keterangan"
                                id="keterangan" rows="3" placeholder="Masukkan keterangan untuk tingkat risiko ini...">{{ old('keterangan', $tingkatRisiko->keterangan) }}</textarea>
                            @error('keterangan')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="form-group mb-4">
                            ...
                            <textarea required class="form-control @error('saran') is-invalid @enderror" name="saran"
                                id="saran" rows="3" placeholder="Berikan saran untuk tingkat risiko ini...">{{ old('saran', $tingkatRisiko->saran) }}</textarea>
                            @error('saran')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
